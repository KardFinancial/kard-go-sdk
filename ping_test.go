...
func TestSettersNetworkBlockedErrorBody(t *testing.T) {
	t.Run("SetMessage", func(t *testing.T) {
		obj := &NetworkBlockedErrorBody{}
...
func TestGettersNetworkBlockedErrorBody(t *testing.T) {
	...
	t.Run("GetMessage_NilReceiver", func(t *testing.T) {
		t.Parallel()
		var obj *NetworkBlockedErrorBody
...
func TestSettersMarkExplicitNetworkBlockedErrorBody(t *testing.T) {
...
func TestSettersPingResponseObject(t *testing.T) {
	t.Run("SetMessage", func(t *testing.T) {
		obj := &PingResponseObject{}
		var fernTestValueMessage string
		obj.SetMessage(fernTestValueMessage)
		assert.Equal(t, fernTestValueMessage, obj.Message)
		assert.NotNil(t, obj.explicitFields)
...
func TestGettersPingResponseObject(t *testing.T) {
	t.Run("GetMessage", func(t *testing.T) {
		t.Parallel()
		// Arrange
		obj := &PingResponseObject{}
...
func TestSettersMarkExplicitPingResponseObject(t *testing.T) {
	t.Run("SetMessage_MarksExplicit", func(t *testing.T) {
		t.Parallel()
		// Arrange
		obj := &PingResponseObject{}
...
func TestJSONMarshalingNetworkBlockedErrorBody(t *testing.T) {
	t.Run("MarshalUnmarshal", func(t *testing.T) {
		...
		var unmarshaled NetworkBlockedErrorBody
...
func TestJSONMarshalingPingResponseObject(t *testing.T) {
	t.Run("MarshalUnmarshal", func(t *testing.T) {
		t.Parallel()
		// Arrange
		obj := &PingResponseObject{}
		...
		// Unmarshal back and verify round-trip
		var unmarshaled PingResponseObject
		err = json.Unmarshal(data, &unmarshaled)
		assert.NoError(t, err, "round-trip unmarshal should succeed")
	})
...
func TestStringNetworkBlockedErrorBody(t *testing.T) {
...
func TestStringPingResponseObject(t *testing.T) {
	t.Run("StringMethod", func(t *testing.T) {
		t.Parallel()
		obj := &PingResponseObject{}
		result := obj.String()
...
func TestExtraPropertiesNetworkBlockedErrorBody(t *testing.T) {
...
func TestExtraPropertiesPingResponseObject(t *testing.T) {
	t.Run("GetExtraProperties", func(t *testing.T) {
		t.Parallel()
		obj := &PingResponseObject{}
		// Should not panic when calling GetExtraProperties()
