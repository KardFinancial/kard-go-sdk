...
func TestSettersGetTokenRequest(t *testing.T) {
	t.Run("SetXKardTargetIssuer", func(t *testing.T) {
		obj := &GetTokenRequest{}
		var fernTestValueXKardTargetIssuer *string
		obj.SetXKardTargetIssuer(fernTestValueXKardTargetIssuer)
		assert.Equal(t, fernTestValueXKardTargetIssuer, obj.XKardTargetIssuer)
...
func TestSettersMarkExplicitGetTokenRequest(t *testing.T) {
	t.Run("SetXKardTargetIssuer_MarksExplicit", func(t *testing.T) {
		t.Parallel()
		// Arrange
		obj := &GetTokenRequest{}
		var fernTestValueXKardTargetIssuer *string
